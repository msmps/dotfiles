...
**Size targets:** README/overview files: 80-130 lines. Detail files (api, configuration, patterns, gotchas): 150-200 lines, max 250. See [anatomy.md](./anatomy.md) for full guidelines.
